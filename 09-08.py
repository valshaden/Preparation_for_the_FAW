...
def show_result_window(api_name, title, data):
    ...
    if api_name in result_windows and result_windows[api_name].winfo_exists():
        ...
        result_window.geometry("1000x600") # Увеличен размер окна для новых столбцов и строк
        ...
        # Создаем Treeview
        tree = ttk.Treeview(frame, columns=columns, show='headings', height=25) # Увеличена высота
